...
CREATE TABLE supplier_materials (
    supplier_material_id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    supplier_id BIGINT,
    material_id BIGINT,
...
CREATE TABLE delivery_items (
    delivery_item_id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    delivery_id BIGINT,
    material_id BIGINT,
...
CREATE TABLE tech_cards (
    tech_card_id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    product_id BIGINT,
...
CREATE TABLE production_batches (
    production_batch_id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    batch_number VARCHAR(80),
    product_id BIGINT,
    tech_card_id BIGINT,
...
CREATE TABLE finished_goods_stock (
    finished_stock_id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    product_id BIGINT,
...
CREATE TABLE quality_checks (
    quality_check_id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE supplier_invoices (
    supplier_invoice_id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
