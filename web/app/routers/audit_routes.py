...
def audit_page(
    ...
    return render_template(
        ...
        "audit.html",
        {
            ...
            "user_options": build_options(users, "user_id", "username", blank_label="All users"),
            "table_options": build_options(tables, "table_name", "table_name", blank_label="All tables"),
            "action_options": [
