...
SECTION_RULES = {
    ...
    "supplier_invoices": {"admin", "warehouse_worker"},
...
ACTION_RULES = {
    ...
    "supplier_invoices.view": {"warehouse_worker"},
    "supplier_invoices.pay": {"admin"},
    "supplier_invoices.manage": {"admin"},
    ...
    "suppliers.manage_materials": {"admin", "warehouse_worker"},
